...
public class InstanceofExam {
	public static void main(String args[]) {
		...
		if (car instanceof Car) {
			System.out.println("car instanceof Car is true"); // T
		} else {
			System.out.println("car instanceof Car is false");
		}

		if (car instanceof EfSonata) { // EfSonata는 Car의 자식이기 때문에 false
			System.out.println("car instanceof EfSonata is true");
		} else {
			System.out.println("car instanceof EfSonata is false"); // F
		}

		if (ef instanceof Car) {
			System.out.println("ef instanceof Car is true"); // T
		} else {
			System.out.println("ef instanceof Car is false");
		}

		if (ex instanceof Car) {
			System.out.println("ex instanceof Car is true"); // T
		} else {
			System.out.println("ex instanceof Car is false");
		}

		if (ca instanceof Car) {
			System.out.println("ca instanceof Car is true"); // T
		} else {
