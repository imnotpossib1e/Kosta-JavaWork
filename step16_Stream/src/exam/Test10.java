...
public class Test10 {
    ...
    public static void main(String[] args) {
        ...
        boolean b = students.stream().anyMatch(s -> s.getMajor().equals("Computer Science"));
        if (b) {
            System.out.println("전공이 Computer Science인 학생이 있습니다.");
        } else {
            System.out.println("전공이 Computer Science인 학생이 없습니다.");
        }
    }
}
