...
public class Test02 {
    ...
    public static void main(String[] args) {
        ...
        Student st = students.stream().max(Comparator.comparingInt(Student::getAge)).orElse(null);

        System.out.println(st);

        // Optional 사용
        Optional<Student> st2 = students.stream().max(Comparator.comparingInt(Student::getAge));
        st2.ifPresent(s -> System.out.println("가장 나이 많은 학생: " + s));
