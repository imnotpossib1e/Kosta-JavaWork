...
interface InterfaceExam00 { // interface - 생성X, 상속X, implements 이용해섯 ㅏ용
...
interface InterfaceExam01 extends InterfaceExam00 {
    ...
    final int i = 767;
    // interface의 모든 필드는 public static final
    /*protected*/ int k = 999;
...
interface InterfaceExam02 {
    ...
    // interface의 모든 메소드는 public abstract
